...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://192.168.1.8/php/getdata.php?username="+username;

        vTagihan = (TextView)findViewById(R.id.txt_vtagihan);
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int a = 0; a < jsonArray.length(); a ++){
                        ...
                        map.put("tagihan", json.getString("tagihan"));
                        list_data.add(map);
                    }
                    vTagihan.setText("Tagihan Semester ini Rp. " + list_data.get(0).get("tagihan") + ",00.");
